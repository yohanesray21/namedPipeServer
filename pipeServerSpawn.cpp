    ...
    while (true)
    {
        ...
        if (ConnectNamedPipe(hCreateNamedPipe, NULL) != false) {
            ...
            while (true) {
                ...
                // Sequence
                //std::string checkOpenProcess{ "OpenProcess" };
                //std::string checkVirtualAllocEx{ "VirtualAllocEx" };
                //std::string checkWriteProcessMemory{ "WriteProcessMemory" };
                //std::string checkCreateRemoteThread{ "CreateRemoteThread" };
               ...
               /* if (test.find(checkOpenProcess) != std::string::npos) {
                    std::cout << "test :" << test << "\r\n";
                    logVec.append(test);
                    logVec.append("\r\n");
                }*/
                /*if (test.find(checkVirtualAllocEx) != std::string::npos) {
                    std::cout << "test :" << test << "\r\n";
                    logVec.append(test);
                    logVec.append("\r\n");
                }*/
               /* if (test.find(checkWriteProcessMemory) != std::string::npos) {
                    std::cout << "test :" << test << "\r\n";
                    logVec.append(test);
                    logVec.append("\r\n");
                }*/
               /* if (test.find(checkCreateRemoteThread) != std::string::npos) {
                    std::cout << "test :" << test << "\r\n";
                    logVec.append(test);
                    logVec.append("\r\n");
                }*/
